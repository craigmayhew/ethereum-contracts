...
const answers = {
    ans24: [-2901096694, -15550555555, 15584139827],
    ans29: [3,1,1]
}
...
for (let ans in answers) {
    ...
    .then(function(e) {
        ...
        storageContract.deploy({
            ...
            console.log(" . Sending prize fund ether to 33.sol (answer="+ans+") on rinkeby to: ", contract33.options.address);
            ...
            .then(function (txnHash) {
                ...
                console.log(" ✔ Sent prize fund ether to 33.sol (answer="+ans+") on rinkeby. transaction: "+txnHash.transactionHash);
                return web3.eth.getTransactionReceiptMined(txnHash.transactionHash);
            })
            .then(function (receipt) {
                console.log(" . Sending correct answer for 33.sol (answer="+ans+")")
                contract33.methods.attempt(answers[ans][0],answers[ans][1],answers[ans][2]).send({
                    from: ethAccount,
                    gas: 1000000
                })
                .then(function(receipt){
                    console.log(" ✔ Sent correct answer for 33.sol (answer="+ans+")")
                })
                .then(function(){
